    ...
    <ul class="home_thumbs">
        ...
        <li>
            <table width="230" border="0" align="center" cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
                        <td colspan="2" align="left" valign="top"><a href="<?php echo base_url() ?>contactus/"><img src="<?php echo base_url() ?>assets/img/home/technology.jpg" alt="Banners/Gazebos/Stands" width="100%" height="auto"></a></td>
                    </tr>
                    <tr>
                        <td width="195" height="48" align="left" bgcolor="#f7fbfc" class="product-heading"><a href="<?php echo base_url() ?>contactus/">Banners/Gazebos/Stands</a></td>
                        <td width="48" align="right" valign="top" bgcolor="#f7fbfc">&nbsp;</td>
                    </tr>
                </tbody>
            </table>
        ...
        <li>
            <table width="230" border="0" align="center" cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
                        <td colspan="2" align="left" valign="top"><a href="<?php echo base_url() ?>contactus"><img src="<?php echo base_url() ?>assets/img/home/custom.jpg" alt="Corporate and Promotional Gifts" width="100%" height="auto"></a></td>
                    </tr>
                    <tr>
                        <td width="195" height="48" align="left" bgcolor="#f7fbfc" class="product-heading"><a href="<?php echo base_url() ?>contactus">Custom Request</a></td>
                        <td width="48" align="right" valign="top" bgcolor="#f7fbfc"><a href="<?php echo base_url() ?>contactus/"></a></td>
                    </tr>
                </tbody>
            </table>
        </li>
